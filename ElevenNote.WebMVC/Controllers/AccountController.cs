    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Edit(string userId)
        {
            ...
            var userEditModel = new UserEdit()
            {
                ...
                Email = User.Email,
                UserId = User.Id,
                Roles = User.Roles.Select(r => r.RoleId) as List<string>,
        ...
        public ActionResult Edit(string userId, UserEdit model)
        {
            ...
            // var thisUser = System.Security.Principal.WindowsIdentity.GetCurrent();
            ...
            if (model.IsAdmin)
            {
                ...
                // TempData["SaveResult"] = string.Join(", ", allRoles.Select(r => r.Name).ToList());
                UserManager.AddToRole(userId, "admin");
            }

            if (UserManager.Update(user).Succeeded)
            {
                // TempData["SaveResult"] = "User updated.";
